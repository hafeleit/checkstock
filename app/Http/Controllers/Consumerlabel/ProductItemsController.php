...
class ProductItemsController extends Controller
{
  ...
  public function destroy(string $id)
  {
    try {
      ...
      return redirect()->route('product-items.index')->with('success', 'Product item deleted successfully!');
    } catch (\Illuminate\Database\Eloquent\ModelNotFoundException $e) {
      return redirect()->back()->with('error', 'The product item you tried to delete was not found.');
    } catch (\Throwable $th) {
      return redirect()->back()->with('error', 'An unexpected error occurred while deleting the product item.');
    }
  }

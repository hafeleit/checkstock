...
class DeliverExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithCustomStartCell
{
    private $mappedData;
    private $headerData;
    ...
    {
        $sheet->setCellValue('A1', 'Delivery Job Sheet');
        $sheet->mergeCells('A1:E1');
        $sheet->getStyle('A1')->getFont()->setBold(true)->setSize(20);
        $sheet->getStyle('A1')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
        $sheet->getStyle('A1')->getAlignment()->setVertical(Alignment::VERTICAL_CENTER);

        $sheet->setCellValue('A2', 'Job No. : ' . $this->headerData['job_no']);
        ...
        $sheet->setCellValue('A4', 'Driver ID: ' . $this->headerData['driver_id']);

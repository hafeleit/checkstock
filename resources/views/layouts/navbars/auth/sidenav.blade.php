...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse h-auto w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <div class="collapse {{ in_array(Request::segment(1), ['sales-usi', 'product-infos', 'product-series']) ? 'show' : '' }}" id="salesUsiExample">
          <ul class="nav nav-sm flex-column">
            ...
            @endcan
            @can('salesusi productseries view')
            <li class="nav-item">
      ...
      <li class="nav-item">
        <a href="{{ route('ass_dashboard.user') }}" class="nav-link">
          <div class="icon icon-shape icon-faq border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="{{ Request::segment(1) == 'ass_dashboard' ? 'text-primary' : 'text-dark' }} text-sm opacity-10" viewBox="0 0 640 640">
      ...
      @can('faq view')
      <li class="nav-item">
        <a class="nav-link {{ Request::segment(1) == 'page-manual-faqs' ? 'active' : '' }}" href="{{ route('page-manual-faqs.index') }}">
          <div class="icon icon-shape icon-faq border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"  fill="currentColor" class="{{ Request::segment(1) == 'page-manual-faqs' ? 'text-primary' : 'text-dark' }} opacity-10" viewBox="0 0 16 16">
              <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
              <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
            </svg>
          </div>
          <span class="nav-link-text ms-1">Page Manual FAQ</span>
        </a>
      </li>
      @endcan

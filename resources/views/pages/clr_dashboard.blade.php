                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <p class="mb-0" style="position: absolute;bottom: 4px;right: 20px;font-size: 14px;">Last update: 13:00</p>
                                </div>
                            </div>
                            <div class="col-4 text-end">
        ...
        new Chart(ctx1, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [ 0, {{ $clr_total['day1_pos'] }}, {{ $clr_total['day2_pos'] }}],
                    maxBarThickness: 6
        ...
        new Chart(ctx_2, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [ 0, {{ $clr_total['day1_total'] }}, {{ $clr_total['day2_total'] }}],
                    maxBarThickness: 6

        ...
        <form action="{{ route('product-items.update', $productitem->id) }}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-end z-index-1">
                    <a href="{{ route('product-items.index') }}" type="button"
                        class="btn btn-secondary mb-0 ms-lg-auto me-lg-0 me-auto mt-lg-0 mt-2">Cancel</a>
                    @can('consumerlabel update')
                        <a href="{{ route('product-items.edit', $productitem->id) }}"
                            class="btn btn-primary mb-0 ms-lg-auto me-lg-0 me-auto mt-lg-0 mt-2">Edit</a>
                    @endcan
                </div>
            </div>
            <div class="row mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    ...
                                    <div class="d-sm-flex bg-gray-100 border-radius-lg p-2">
                                        <p class="text-sm font-weight-bold my-auto ps-sm-2">
                                            {{ $productitem->supplier_item ?? '' }}</p>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">Type</label>
                                    <div class="d-sm-flex bg-gray-100 border-radius-lg p-2">
                                        <p class="text-sm font-weight-bold my-auto ps-sm-2">{{ $productitem->type ?? '' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="d-sm-flex bg-gray-100 border-radius-lg p-2">
                                        <p class="text-sm font-weight-bold my-auto ps-sm-2">
                                            {{ $productitem->defrosting_power ?? '' }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    ...
                                    <div class="d-sm-flex bg-gray-100 border-radius-lg p-2">
                                        <p class="text-sm font-weight-bold my-auto ps-sm-2">
                                            {{ $productitem->nominal_electricity ?? '' }}</p>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="d-sm-flex bg-gray-100 border-radius-lg p-2">
                                        <p class="text-sm font-weight-bold my-auto ps-sm-2">
                                            {{ $productitem->max_power_of_lamp ?? '' }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    ...
                                    <div class="d-sm-flex bg-gray-100 border-radius-lg p-2">
                                        <p class="text-sm font-weight-bold my-auto ps-sm-2">
                                            {{ $productitem->electric_power_phase ?? '' }}</p>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    ...
                                    <div class="d-sm-flex bg-gray-100 border-radius-lg p-2">
                                        <p class="text-sm font-weight-bold my-auto ps-sm-2">
                                            {{ $productitem->star_rating_freezer ?? '' }}</p>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="d-sm-flex bg-gray-100 border-radius-lg p-2">
                                        <p class="text-sm font-weight-bold my-auto ps-sm-2">
                                            {{ $productitem->energy_cons_per_year ?? '' }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">

                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <input class="form-control" type="text" name="made_by"
                                        value="{{ $productitem->made_by ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <label class="mt-4 text-sm">Material Text</label>
                                    <input class="form-control" type="text" name="material_text"
                                        value="{{ $productitem->material_text ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <input class="form-control" type="text" name="grade_code_1"
                                        value="{{ $productitem->grade_code_1 ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <label class="mt-4 text-sm">Material Color</label>
                                    <input class="form-control" type="text" name="material_color"
                                        value="{{ $productitem->material_color ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <input class="form-control" type="text" name="remark"
                                        value="{{ $productitem->remark ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <label class="mt-4 text-sm">Item Size</label>
                                    <input class="form-control" type="text" name="item_size"
                                        value="{{ $productitem->item_size ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">Item Amout</label>
                                    <input class="form-control" type="text" name="item_amout"
                                        value="{{ $productitem->item_amout ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">Item Type</label>
                                    <input class="form-control" type="text" name="item_type"
                                        value="{{ $productitem->item_type ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <label class="mt-4 text-sm">Factory Name</label>
                                    <input class="form-control" type="text" name="factory_name"
                                        value="{{ $productitem->factory_name ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">Factory Address</label>
                                    <input class="form-control" type="text" name="factory_address"
                                        value="{{ $productitem->factory_address ?? '' }}">
                                </div>
                            </div>
                            <h1>TIS</h1>
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    ...
                                    <input class="form-control" type="text" name="format_id"
                                        value="{{ $productitem->format_id ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">Supplier Code</label>
                                    <input class="form-control" type="text" name="supplier_code"
                                        value="{{ $productitem->supplier_code ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <label class="mt-4 text-sm">Supplier Item</label>
                                    <input class="form-control" type="text" name="supplier_item"
                                        value="{{ $productitem->supplier_item ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    ...
                                    <input class="form-control" type="text" name="format"
                                        value="{{ $productitem->format ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">Model</label>
                                    <input class="form-control" type="text" name="model"
                                        value="{{ $productitem->model ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    ...
                                    <input class="form-control" type="text" name="gross_int"
                                        value="{{ $productitem->gross_int ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">Nominal Voltage</label>
                                    <input class="form-control" type="text" name="nominal_voltage"
                                        value="{{ $productitem->nominal_voltage ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <label class="mt-4 text-sm">Nominal Freq</label>
                                    <input class="form-control" type="text" name="nominal_freq"
                                        value="{{ $productitem->nominal_freq ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">Defrosting Power</label>
                                    <input class="form-control" type="text" name="defrosting_power"
                                        value="{{ $productitem->defrosting_power ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <label class="mt-4 text-sm">Nominal Electricity</label>
                                    <input class="form-control" type="text" name="nominal_electricity"
                                        value="{{ $productitem->nominal_electricity ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">Max Power Of Lamp</label>
                                    <input class="form-control" type="text" name="max_power_of_lamp"
                                        value="{{ $productitem->max_power_of_lamp ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <label class="mt-4 text-sm">Electric Power Phase</label>
                                    <input class="form-control" type="text" name="electric_power_phase"
                                        value="{{ $productitem->electric_power_phase ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">Nominal Power</label>
                                    <input class="form-control" type="text" name="nominal_power"
                                        value="{{ $productitem->nominal_power ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <label class="mt-4 text-sm">Star Rating Freezer</label>
                                    <input class="form-control" type="text" name="star_rating_freezer"
                                        value="{{ $productitem->star_rating_freezer ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">Energy Cons Per Year</label>
                                    <input class="form-control" type="text" name="energy_cons_per_year"
                                        value="{{ $productitem->energy_cons_per_year ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <label class="mt-4 text-sm">Climate Class</label>
                                    <input class="form-control" type="text" name="climate_class"
                                        value="{{ $productitem->climate_class ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">Refrigerant</label>
                                    <input class="form-control" type="text" name="refrigerant"
                                        value="{{ $productitem->refrigerant ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <label class="mt-4 text-sm">TIS 1</label>
                                    <input class="form-control" type="text" name="tis_1"
                                        value="{{ $productitem->tis_1 ?? '' }}">
                                </div>
                                <!-- <div class="col-12 col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    ...
                                    <input class="form-control" type="text" name="series_name"
                                        value="{{ $productitem->series_name ?? '' }}">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <label class="mt-4 text-sm">QR-Code</label>
                                    <input class="form-control" type="text" name="qr_code"
                                        value="{{ $productitem->qr_code ?? '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-12 mt-3 mt-sm-0">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault"
                                            name="status" {{ $productitem->status == 'Active' ? 'Checked' : '' }}
                                            value="Active">
                                    </div>
                                </div>
                            </div>

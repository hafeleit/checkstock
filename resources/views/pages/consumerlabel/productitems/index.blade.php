                        ...
                        <div class="d-lg-flex">
                            ...
                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                <div class="ms-auto my-auto">
                                    ...
                                    <div class="modal fade" id="import" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog mt-lg-10">
                                            <div class="modal-content">
                                                ...
                                                <form id="import-form" action="{{ route('productitems_import') }}"
                                    ...
                                    <a class="btn btn-outline-primary btn-sm export mb-0 mt-sm-0 mt-1" id="btn_export"
                                        href="{{ route('productitems_export') }}">
                                        Export
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="dataTable-dropdown">
                                        <label>
                                            <form id="form_search" class=""
                                                action="{{ route('product-items.index') }}" method="get">
                                                ...
                                                </select> entries per page {{ request()->perpage }}
                                        </label>
                                    </div>
                                            ...
                                            @if (count($productitems) > 0)
                                                @foreach ($productitems as $product)
                                                    <tr>
                                                        ...
                                                        <td class="text-sm">
                                                            <a href="#" class="barcode-link" data-bs-toggle="modal"
                                                                data-bs-target="#modal-barcode"
                                                                data-bs-original-title="Download Barcode"
                                                                data-item-code="{{ $product->item_code }}">
                                                                <i class="fas fa-barcode text-lg text-danger"
                                                                    aria-hidden="true"></i>
                                                            </a>
                                                        </td>
                                                        <td class="text-sm">
                                                            <a href="{{ route('product-items.show', $product->id) }}"
                                                            ...
                                                            @can('consumerlabel update')
                                                                <a href="{{ route('product-items.edit', $product->id) }}"
                                                                    class="mx-3" data-bs-toggle="tooltip"
                                                                    data-bs-original-title="Edit Product">
                                                                    <i class="fas fa-pen text-secondary"
                                                                        aria-hidden="true"></i>
                                                                </a>
                                                            @endcan
                                                        </td>

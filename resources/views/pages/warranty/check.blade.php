                    ...
                    <div class="card z-index-0">
                        <div class="text-center">
                            <a href="{{ route('register-warranty.index') }}">
                                <button type="button" class="btn bg-gradient-danger w-50 my-4 mb-2">
                                    Register Warranty
                                </button>
                            </a>
                        </div>
                        ...
                        <div class="card-body">
                            <form role="form">
                                <div class="mb-3">
                                    <label class="img text-sm">
                                        Search serial no or phone number
                                        <span class="text-danger"></span>
                                    </label>
                                    <input id="search" name="search" type="text" class="form-control"
                                        placeholder="serial no or phone number">
                                </div>
                                <div class="card-body p-0 pb-0" id="get_warranty">
                                </div>
                                <div class="text-center">
                                    <button id="btn_search" type="button" class="btn bg-gradient-success w-100 my-4 mb-2">
                                        Search
                                    </button>
                                </div>
                            </form>
            ...
            $("#btn_search").on("click", function() {
                ...
                $.ajax({
                    ...
                    if (jqxhr.status == 422) {
                        ...
                        if (errors.search) {
                            let errorMessage = errors.search[0]
                            $('#search').addClass('is-invalid');
                            $('#search').after(
                                '<div class="text-danger text-xs mt-1" id="search-error">' +
                                errorMessage + '</div>');
                        }
                    }

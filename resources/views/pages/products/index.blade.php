                        ...
                        <div class="table-responsive p-0" id="get-products">
                          ...
                          <table class="table align-items-center mb-0">
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      <td>
                                        <div class="d-flex px-2 py-1"> <div> <img src="/img/products/coming_soon.jpg" class="avatar avatar-sm me-3" alt="user1"> </div> <div class="d-flex flex-column justify-content-center">

...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Edit Asset Type'])
        ...
        <form action="{{ route('asset_types.update', $assetType->id) }}" method="post">
            ...
            <div class="row align-items-center mb-4">
                <div class="col-lg-6 z-1">
                    <h4 class="text-white mb-0">Edit Asset Type</h4>
                    <p class="text-white text-sm opacity-8 mb-0">Update information for this asset type</p>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control" type="text" name="type_desc" placeholder="e.g. Notebook, Printer" value="{{ $assetType->type_desc }}" required>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select class="form-control" name="type_status" required>
                                        ...
                                        <option value="Inactive" {{ $assetType->type_status == 'Inactive' ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
                                </div>
                            </div>

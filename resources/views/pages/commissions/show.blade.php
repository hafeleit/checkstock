...
<div class="container-fluid py-4">
  ...
  <div class="modal-dialog">
    <form method="POST" action="{{ route('commissions.adjust.update', $ar->id) }}" class="needs-validation" novalidate>
      @csrf
      @method('PUT')
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- Sales Rep -->
          <div class="mb-3">
            <label for="sales_rep_edit_{{ $ar->id }}">Sales Rep <span class="text-danger">*</span></label>
            <select id="sales_rep_edit_{{ $ar->id }}" name="sales_rep" class="form-select" required>
            ...
            <div class="invalid-feedback">กรุณาเลือก Sales Rep</div>
          </div>

          <!-- Reference Document -->
          <div class="mb-3">
            <label>Reference Document <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="reference_key" value="{{ $ar->reference_key }}" required>
            <div class="invalid-feedback">กรุณากรอก Reference Document</div>
          </div>

          <!-- Commissions -->
          <div class="mb-3">
            <label>Commissions <span class="text-danger">*</span></label>
            <input type="number" step="0.01" class="form-control" name="commissions" value="{{ $ar->commissions }}" required>
            <div class="invalid-feedback">กรุณากรอก Commissions</div>
          </div>

          <!-- Remark (with previous remarks + create new) -->
          <div class="mb-3">
            <label>Remark <span class="text-danger">*</span></label>
            <input type="text" id="remark_edit_{{ $ar->id }}" name="remark" class="form-control" value="{{ $ar->remark }}" required>
            <div class="invalid-feedback">กรุณากรอก Remark</div>
          </div>
        </div>
...
<div class="modal fade" id="adjustModal" tabindex="-1" aria-labelledby="adjustModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form method="POST" action="{{ route('commissions.adjust', $commission->id) }}" class="needs-validation" novalidate>
      @csrf
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <!-- Sales Rep -->
          <div class="mb-3">
            <label for="sales_rep" class="form-label">Sales Code <span class="text-danger">*</span></label>
          ...
          <!-- Reference Document -->
          <div class="mb-3">
            <label for="reference_key" class="form-label">Reference Document / Credit Note Number <span class="text-danger">*</span></label>
          ...
          <!-- Commission Amount -->
          <div class="mb-3">
            <label for="commissions" class="form-label">Commission Amount(THB) <span class="text-danger">*</span></label>

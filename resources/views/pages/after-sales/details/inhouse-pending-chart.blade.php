...
@section('content')
    ...
    <div class="space-y-2">
        <div class="bg-white rounded-lg px-3 py-4 shadow-sm border border-gray-100 w-full">
            <p class="text-md font-semibold text-gray-600 mb-2">Inhouse Pending by Team</p>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 w-full overflow-hidden">
            <div class="px-3 py-3 border-b border-gray-100">
                <p class="text-sm text-gray-400 uppercase tracking-widest font-semibold">Inhouse Pending Tickets</p>
                ...
                <table class="w-full min-w-[700px] text-xs">
                    <thead class="bg-gray-50 text-gray-500 uppercase tracking-wider">
                        <tr>
                            ...
                            <th class="px-3 py-2 text-left font-semibold whitespace-nowrap">Assignee</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        @forelse ($tickets as $ticket)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-2 text-gray-600 whitespace-nowrap">{{ $ticket->team ?? '-' }}</td>
                                <td class="px-3 py-2 text-gray-600 whitespace-nowrap">{{ $ticket->assignee_name ?? '-' }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="px-3 py-6 text-center text-gray-400">No tickets found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    @push('scripts')
        ...
        <script nonce="{{ request()->attributes->get('csp_script_nonce') }}">
            ...
            new Chart(document.getElementById('ud-inhouse-chart'), {
                type: 'bar',
                data: {
                    labels: udInhouseRows.map(r => r.label),

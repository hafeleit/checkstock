  ...
  <BODY>
        ...
        <TABLE cellpadding=0 cellspacing=0 class="t0" style="padding:-2px 0px 0px 0px;">
          <TR>
            ...
            <TD colspan=3 class="tr0 td4">
              <P class="p4 ft1" style="margin-left: -9px;">{{$productItems["item_code"]}}</P>
            </TD>
            <TD class="tr1 tdLeft_1">
              <P class="p4 ft1">
                <img src="img/logos/Logo-HAFELE-02.jpg" width="55" style="margin: 3px 0px 0px -37px">
              </P>
            </TD>
          </TR>
          <TR>
          ...
          <TR>
            ...
            <TD colspan=4 class="tr0 td4">
              <P class="p4 ft2" style="margin-left: -19px; ">{{$productItems["how_to_text"]}}</P>
            </TD>
          </TR>
          <TR>
	...
	?> <TR>
            ...
            <TD colspan=4 class="tr0 td5">
              <P class="p4 ft1" style="margin-left: 8px;">{{$item_amout}}</P>
            </TD>
          </TR>
          <TR>
            <TD class="tr0 tdLeft_1">
          ...
          <TR>
            ...
            <TD colspan=4 class="tr0 td5">
              <P class="p4 ft1" style="margin-left: -20px; ">{{$productItems["item_size"]}}</P>
            </TD>
          </TR>
          <TR> @if($productItems["made_by"] =='ไทย') <TD colspan=5 class="tr0 tdLeft_1">
          ...
          <TR> @if($productItems["made_by"] =='ไทย') <TD colspan=5 class="tr6 td7">
            ...
            </TD> @else <TD colspan=5 class="tr6 td7">
          ...
          <TR>
            <TD colspan=5 class="tr0 td6">
              <P class="p4 ft4" style="">{{$productItems["warning_text"]}}</P>
            </TD>
          </TR>
          <TR> @if($productItems["made_by"] =='ไทย') <TD colspan=5 class="tr0 tdLeft_1">

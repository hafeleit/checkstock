...
/* #page_1 {position:relative; overflow: hidden;margin: 0px 0px 0px 0px;padding: 0px;border: none;width: 200px;height: 159px;top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);} */
	#page_1 {position:relative; overflow: hidden;margin: 0px 0px 0px 0px;padding: 0px;border: none;}

#page_1 #p1dimg1 {position:absolute;top:0px;left:0px;z-index:-1;width:189px;height:154px;}
#page_1 #p1dimg1 #p1img1 {width:189px;height:152px;}
...
.ft16{font: 16px 'AngsanaUPC';line-height: 11px;}

.p0{text-align: left;padding-left: 10px;margin-top: 2px;margin-bottom: 0px;}
.p1{text-align: left;padding-left: 10px;margin-top: 0px;margin-bottom: 0px;}
.p2{text-align: left;padding-left: 4px;margin-top: 0px;margin-bottom: 0px;white-space: nowrap;}
.p3{text-align: right;padding-right: 30px;margin-top: 0px;margin-bottom: 0px;white-space: nowrap;}
...
.p8{text-align: left;padding-left: 9px;margin-top: 0px;margin-bottom: 0px;white-space: nowrap;}
.p9{text-align: right;padding-right: 10px;margin-top: 0px;margin-bottom: 0px;white-space: nowrap;}

.td0{padding: 0px;margin: 0px;width: 47px;vertical-align: bottom;}
.td1{padding: 0px;margin: 0px;width: 51px;vertical-align: bottom;}
.td2{padding: 0px;margin: 0px;width: 5px;vertical-align: bottom;}
.td3{padding: 0px;margin: 0px;width: 25px;vertical-align: bottom;}
.td4{padding: 0px;margin: 0px;width: 100px;vertical-align: bottom;}
.td5{padding: 0px;margin: 0px;width: 72px;vertical-align: bottom;}
.td6{padding: 0px;margin: 0px;width: 80px;vertical-align: top;}
.td7{padding: 0px;margin: 0px;width: 6px;vertical-align: top;}
.td8{padding: 0px;margin: 0px;width: 4px;vertical-align: bottom;}
.tdLeft_1{padding: 0px;margin: 0px;vertical-align: bottom;}
.tdLeft_2{padding: 0px;margin: 0px;vertical-align: bottom;}
...
.tr10{height: 3px;}
.tr01{height: 7px;}
.t0{margin-left: 1px;margin-top: 10px;font: 14px 'AngsanaUPC';
/*border:solid 1px red;*/
}
.dBorder{
	border: solid 1px transparent;
	border-radius: 8px;
	width:187px;height:340px;
...
?>
<?php if($i==5 || $i==9 || $i==13 || $i==17 || $i==21 || $i==25){?>
...
<div  class="{{$cClass}}">
	...
	<TR>
		<TD colspan=5 class="tr0 td4"><P class="p4 ft1">{{$productItems["suggest_text"]}}</P></TD>
	</TR>

	<?php
	$item_amout = substr(trim($productItems["item_amout"]),0,36);

	?>
	<TR>
		<TD class="tr8 tdLeft_2"><P class="p4 ft1">ปริมาณบรรจุ</P></TD>
		<TD colspan=4 class="tr0 td5"><P class="p4 ft1" style="margin-left: 8px;">{{$item_amout}}</P></TD>
	</TR>

	<TR>
		<TD class="tr0 tdLeft_1"><P class="p4 ft1">ราคา</P></TD>
		<TD colspan=4 class="tr0 td5"><P class="p4 ft1">บาท</P></TD>
	</TR>
	<TR>
	...
	<TR>
		@if($productItems["made_by"] =='ไทย')
			<TD colspan=5 class="tr0 tdLeft_1" ><P class="p4 ft1" >ผลิตโดย</P></TD>
		@else
			<TD colspan=5 class="tr0 tdLeft_1" ><P class="p4 ft1" >ประเทศที่ผลิต</P></TD>
		@endif
	</TR>
	<TR>
		@if($productItems["made_by"] =='ไทย')
		...
		@else
			<TD colspan=5 class="tr6 td7" >
				<P class="p4 ft7">{{ $productItems["made_by"] }}</P>
			</TD>
		@endif
	</TR>
	<TR>
		<TD colspan=5 class="tr0 tdLeft_1" ><P class="p4 ft3" >คำเตือน</P></TD>
	</TR>
	<TR>
		<TD colspan=5 class="tr0 td6" ><P class="p4 ft4" style="">{{$productItems["warning_text"]}}</P></TD>
	</TR>
	<TR>
		@if($productItems["made_by"] =='ไทย')
			<TD colspan=5 class="tr0 tdLeft_1" ><P class="p4 ft5">จัดจำหน่ายโดย</P></TD>
		@else
			<TD colspan=5 class="tr0 tdLeft_1" ><P class="p4 ft5">นำเข้าและจัดจำหน่ายโดย</P></TD>
		@endif
	</TR>
	<TR>
		<TD colspan=5 class="tr6 td7" >
		<P class="p4 ft6">บ.เฮเฟเล่ (ประเทศไทย) จำกัด</P>
		<P class="p4 ft6">57 ซ.สุขุมวิท 64 พระโขนงใต้</P>
		<P class="p4 ft6">พระโขนง กทม. 10260 </P>
		</TD>
	</TR>
	<TR>
		<TD colspan=5 class="tr0 tdLeft_1"  ><P class="p4 ft1">วัน/เดือน/ปีที่ผลิต</P></TD>
	</TR>
	<TR>
		<TD colspan=5 class="tr0 td1"><P class="p4 ft1">
		{{ $productItems["man_date"] }}

		</P></TD>
	</TR>
	<!-- <TR>
		<TD class="tr01 tdLeft_1"><P class="p4 ft5">&nbsp;</P></TD>
		<TD class="tr01 td1"><P class="p4 ft5">&nbsp;</P></TD>
		<TD  class="tr01 td3"><P class="p4 ft5">&nbsp;</P></TD>
		<TD colspan=2 class="tr01 td8"><P class="p4 ft5">&nbsp;</P></TD>
	</TR> -->
	<tr><td colspan=5  >
				<table width="100%" cellpadding=0 cellspacing=0 >
					<tr>
								<!-- <td class="tr9 tdLeft_1">
								...
								<td class="tr9 td4" valign="top" align="center" style="padding:0px 0px 0px 0px;line-height:10%;">
									...
									<p style="margin:-2px 0px 0px 85px;"><B>
										...
										{{$productItems["bar_code"][6]}}&nbsp;&nbsp;
										{{$productItems["bar_code"][7]}}
					...
					<!-- <TR>
						<TD class="tr9 tdLeft_1" ><P class="p4 ft1" style="margin-top:-15px;">ควบคุมการผลิตด้วย</P></TD>

					</TR>
					<TR>
						<TD class="tr9 tdLeft_1"><P class="p4 ft1" style="margin-top:-15px;">มาตรฐานการจัดการ</P></TD>
					</TR>
					<TR>
						<TD class="tr9 tdLeft_1"><P class="p4 ft1" style="margin-top:-15px;">ของเฮเฟเล่ เยอรมนี</P></TD>
					</TR> -->
				</table>
	</td></tr>
	</TABLE>
...
<!--<div style="background-color:red;border:solid 1px blue;margin-top:-5px;zIndex:1000px;">81001054444</div>-->
</BODY>
</HTML>

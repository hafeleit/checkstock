...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('OW_MONTHWISE_STK_SUM_WEB_HAFL', function (Blueprint $table) {
            ...
            $table->integer('MSS_INV_COUNT_01');
            $table->integer('MSS_INV_COUNT_02');
            $table->integer('MSS_INV_COUNT_03');
            $table->integer('MSS_INV_COUNT_04');
            $table->integer('MSS_INV_COUNT_05');
            $table->integer('MSS_INV_COUNT_06');
            $table->integer('MSS_INV_COUNT_07');
            $table->integer('MSS_INV_COUNT_08');
            $table->integer('MSS_INV_COUNT_09');
            $table->integer('MSS_INV_COUNT_10');
            $table->integer('MSS_INV_COUNT_11');
            $table->integer('MSS_INV_COUNT_12');
            $table->integer('MSS_INV_COUNT_13');
